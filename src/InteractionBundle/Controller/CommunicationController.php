...
use MainBundle\Entity\Demande;
use MainBundle\Entity\Relation;
...
class CommunicationController extends Controller
{
    public function demandeAction(Request $request)
    {
        ...
        $user = $manager->getRepository("MainBundle:User")->find($request->get("user"));
        $demande = new Demande();
    ...
    public function acceptDemandeAction(Request $request)
    {
        ...
        $manager = $this->getDoctrine()->getManager();
        $user = $manager->getRepository("MainBundle:User")->find($request->get("user"));
        $demande = $manager->getRepository("MainBundle:Demande")->find($request->get("demande"));
